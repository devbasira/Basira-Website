...
export default function PortfolioLayout() {
  ...
  return (
    <div className="grid lg:grid-cols-4 lg:w-[1288px] h-screen">
      <div className="p-[30px] lg:pr-[30px] pr-[60px]  col-span-1 lg:overflow-y-auto lg:items-start lg:w-[350px] w-screen lg:h-screen flex flex-col justify-between h-[90vh]">
          ...
          <form className="space-y-[15px]" onSubmit={handleSubmit}>
            <div className="flex lg:justify-between h-[50px] items-center ">
              <input
                ...
                className="w-auto h-[50px] px-4 py-2 border-t border-gray-100 border-b border-b-[#4a4a4a] focus:outline-none focus:bg-gray-100 placeholder-gray-500"
                value={email}
              ...
              <button
                type="submit"
                disabled={loading}
                className="lg:ml-0 ml-5 w-[50px] h-[50px] bg-[#4A4A4A] hover:bg-[#8A3324] focus:ring-4 focus:outline-none focus:ring-[#B8E1BB] font-medium rounded-full text-sm flex justify-center items-center transition-transform duration-300 hover:-rotate-45"
              >
                {loading ? (
                  <svg
